...
// SOLUZIONE RESA FAIR usando una variabile di mutex
// per gestire l'ordinamento di ingresso
...
typedef struct {
  ...
  pthread_mutex_t ordering; //determina ordine di ingressso
} rw;
